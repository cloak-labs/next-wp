...
/* Function definition:
  useSlugModifier() takes an array of posts (or a single post object), and modifies each post's slug based on your NextWP config option "postBaseSlugs". 
  ...
  you must specify 'postBaseSlugs': { post: 'blog/' } in your next-wp.config.js file. This ensures any time you fetch blog posts from WordPress, each post's slug property gets prepended with 'blog/',
