...
function usePreview(previewParams) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, revisionId, postId, postTypeRestEndpoint, rest, data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = previewParams.post, revisionId = _a.revisionId, postId = _a.postId, postTypeRestEndpoint = _a.postTypeRestEndpoint, rest = __rest(_a, ["revisionId", "postId", "postTypeRestEndpoint"]);
