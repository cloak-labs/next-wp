...
function Heading(_a) {
    ...
    return (0, jsx_runtime_1.jsx)(Tag, __assign({ className: (0, classNames_1.default)(block.isNested && "py-2", classes, className), style: styles, block: block }, { children: (0, html_react_parser_1.default)(content) }));
}
