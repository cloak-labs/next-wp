...
function Paragraph(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("p", __assign({ className: (0, classNames_1.default)("h-min-content", classes, ((_c = (_b = block === null || block === void 0 ? void 0 : block.data) === null || _b === void 0 ? void 0 : _b.attrs) === null || _c === void 0 ? void 0 : _c.backgroundColor) ? "p-6" : 'pb-6', className), style: styles }, { children: (0, html_react_parser_1.default)(block.data.attrs.content) })));
}
