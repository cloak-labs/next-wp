...
function Group(_ref) {
  ...
  if (!(block !== null && block !== void 0 && (_block$data = block.data) !== null && _block$data !== void 0 && _block$data.innerBlocks)) return /*#__PURE__*/React.createElement(React.Fragment, null);
  const {
    layout,
    align
  } = block.data.attrs;
  ...
  if (align != 'full') {
    ...
    return /*#__PURE__*/React.createElement(_Container.default, {
      ...
      style: styles
    }, block === null || block === void 0 ? void 0 : (_block$data3 = block.data) === null || _block$data3 === void 0 ? void 0 : (_block$data3$innerBlo = _block$data3.innerBlocks) === null || _block$data3$innerBlo === void 0 ? void 0 : _block$data3$innerBlo.map((innerBlock, index) => /*#__PURE__*/React.createElement(_Block.default, {
      key: index,
      block: innerBlock,
      parentBlock: block,
      isNested: true,
    ...
    }, block === null || block === void 0 ? void 0 : (_block$data4 = block.data) === null || _block$data4 === void 0 ? void 0 : (_block$data4$innerBlo = _block$data4.innerBlocks) === null || _block$data4$innerBlo === void 0 ? void 0 : _block$data4$innerBlo.map((innerBlock, index) => /*#__PURE__*/React.createElement(_Block.default, {
      key: index,
      block: innerBlock,
      parentBlock: block,
      isNested: true,
