...
function AdminBar(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: "w-full flex items-center justify-center bg-gray-900 text-gray-200 px-8 py-1.5" }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: 'flex' }, { children: [(0, jsx_runtime_1.jsx)("p", __assign({ className: "font-medium mb-0 text-base leading-7 flew-grow mr-4" }, { children: "You are previewing unpublished changes." })), (0, jsx_runtime_1.jsx)(Button_1.default, __assign({ color: 'gray', className: "py-1", href: href, size: "small", openInNewTab: false }, { children: "Exit Preview" }))] })) })));
}
