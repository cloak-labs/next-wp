...
function Button(_a) {
    var _b = _a.color, color = _b === void 0 ? 'navy' : _b, _c = _a.variant, variant = _c === void 0 ? 'solid' : _c, _d = _a.size, size = _d === void 0 ? 'reg' : _d, _e = _a.type, type = _e === void 0 ? 'button' : _e, href = _a.href, className = _a.className, children = _a.children, props = __rest(_a, ["color", "variant", "size", "type", "href", "className", "children"]);
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: href ? ((0, jsx_runtime_1.jsx)(Link_1.default, __assign({ href: href, className: classes }, props, { children: children }))) : ((0, jsx_runtime_1.jsx)("button", __assign({ type: type, className: classes }, props, { children: (0, jsx_runtime_1.jsx)("span", __assign({ className: "w-full" }, { children: children })) }))) }));
}
