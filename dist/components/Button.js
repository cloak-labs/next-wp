...
function Button(_a) {
    var _b = _a.color, color = _b === void 0 ? 'navy' : _b, _c = _a.variant, variant = _c === void 0 ? 'solid' : _c, _d = _a.size, size = _d === void 0 ? 'reg' : _d, href = _a.href, icon = _a.icon, _e = _a.trailingIcon, trailingIcon = _e === void 0 ? true : _e, _f = _a.isLoading, isLoading = _f === void 0 ? false : _f, className = _a.className, _g = _a.linkProps, linkProps = _g === void 0 ? {} : _g, children = _a.children;
    return ((0, jsx_runtime_1.jsx)(Link_1.default, __assign({ href: href }, linkProps, { children: (0, jsx_runtime_1.jsx)("button", __assign({ type: "button", className: (0, classNames_1.classNames)("inline-flex items-center justify-center border border-transparent font-semibold rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2", size === 'small' && 'text-xs px-4 py-1.5', size === 'reg' && 'text-sm px-6 py-2.5', size === 'large' && 'text-base px-8 py-3', baseStyles[variant], variantStyles[variant][color], className) }, { children: (0, jsx_runtime_1.jsx)("span", __assign({ className: "w-full" }, { children: children })) })) })));
}
