...
var HeroIcon_1 = require("./HeroIcon");
...
function Button(_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(ConditionalWrapper_1.default, __assign({ condition: href, wrapper: function (children) { return (0, jsx_runtime_1.jsx)(link_1.default, __assign({ href: href }, { children: (0, jsx_runtime_1.jsx)("a", __assign({ className: className }, { children: children })) })); } }, { children: (0, jsx_runtime_1.jsxs)("button", __assign({ type: "button", className: (0, classNames_1.default)("inline-flex items-center justify-center border border-transparent font-semibold rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2", size === 'small' && 'text-xs px-4 py-1.5', size === 'reg' && 'text-sm px-6 py-2.5', size === 'large' && 'text-base px-8 py-3', baseStyles[variant], variantStyles[variant][color], !href && className) }, { children: [trailingIcon && (0, jsx_runtime_1.jsx)("span", __assign({ className: "w-full" }, { children: children })), (icon && !isLoading) &&
                    (0, jsx_runtime_1.jsx)(HeroIcon_1.default, { icon: icon, className: (0, classNames_1.default)("w-5 h-5 mt-px", trailingIcon ? "ml-2" : "mr-2"), "aria-hidden": "true" }), !trailingIcon && (0, jsx_runtime_1.jsx)("span", __assign({ className: "w-full" }, { children: children }))] })) })));
}
