        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!revisionId)
                        return [2 /*return*/, res.status(401).json({ message: 'A post revision ID was not supplied -- pass it in via a "revisionId" parameter.' })];
                    if (!postId)
                    ...
                    return [4 /*yield*/, (0, usePost_1.usePost)({
                            postType: postTypeRestEndpoint,
                            id: postId
                        })];
                case 2:
                    postSlug = (_b.sent()).data.slug;
